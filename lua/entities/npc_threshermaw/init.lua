...
ENT.NPCFaction = NPC_FACTION_THRESHER
ENT.iClass = CLASS_THRESHER
util.AddNPCClassAlly(CLASS_THRESHER,"npc_threshermaw")
ENT.sModel = "models/masseffect/threshermaw.mdl"
