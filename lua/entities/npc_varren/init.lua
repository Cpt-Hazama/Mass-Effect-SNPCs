...
function ENT:SetupSLVFactions()
	self:SetNPCFaction(NPC_FACTION_VARREN,CLASS_VARREN)
end
ENT.sModel = "models/oblivion/mudcrab.mdl"
...
ENT.m_tbSounds = {
	["Attack"] = "mudcrab_attack0[1-2].mp3",
	["Death"] = "mudcrab_death0[1-2].mp3",
	["Idle"] = "mudcrab_idle0[1-2].mp3",
	["Pain"] = "mudcrab_injured01.mp3",
	["FootLeft"] = "foot/mudcrab_foot0[1-3].mp3",
	["FootRight"] = "foot/mudcrab_foot0[1-3].mp3",
	["Foot"] = "foot/mudcrab_foot0[1-3].mp3"
}
...
function ENT:UnBurrow()
	...
	self:CallOnInitialized(function() self:SLVPlayActivity(ACT_DEPLOY) end)
	self.m_unburrow = nil
...
function ENT:Burrow(tmUnburrow)
	...
	self:CallOnInitialized(function() self:SLVPlayActivity(ACT_UNDEPLOY) end)
end
